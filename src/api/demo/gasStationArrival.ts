...
enum Api {
  // 气站到货验收管理
  fl_acceptance_add_list = '/v1/fl_acceptance', // add/list
  fl_acceptance_update = '/v1/fl_acceptance/update', // update
  fl_acceptance_delete = '/v1/fl_acceptance/delete', // delete
  fl_acceptance_detail = '/v1/fl_acceptance/', // detail
  // 供货商管理
  fl_supplier_list = '/v1/fl_supplier', // add/list
  // 地磅检测管理
  fl_detection_list = '/v1/fl_detection', // list
  // 气体类型 0 天然气 1氧气 2二氧化碳 3氩气
  //到货状态
  // 填充（充装） fl_filling
}
