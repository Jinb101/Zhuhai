export default {
  workload: {
    ...
    record: 'Workload Reporting Records',
    manage: 'Project management',
  },
  gasStationArrival: {
    manage: 'Acceptance management',
    acceptance: 'Arrival acceptance',
    personnel: 'Alarm personnel',
    supplier: 'Supplier management',
    weighbridge: 'Weighbridge detection',
  },
  gasBottleStationArrival: {
    manage: 'Air cylinder received acceptance',
    received: 'Gas cylinder received',
