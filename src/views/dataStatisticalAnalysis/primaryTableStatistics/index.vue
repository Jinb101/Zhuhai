<template>
  <div class="w-full h-full px-4 py-4">
    ...
    <div class="!my-4 enter-y">
      <a-modal v-model:visible="visibleFlow" title="实时流量图表" :footer="null" width="1000px" @cancel="closeFlowModal">
        <div class="h-[10%] w-full bg-white flex justify-start items-center px-4" style="margin-top: 10px">
          <div class="w-4/5">
        ...
        <div style="padding-left: 20px;padding-top: 20px;padding-bottom: 20px;padding-right: 10px;" v-if="showChart">
          <h3>生产监测-重大危险源</h3>
          <VisitAnalysis />
        </div>
      </a-modal>
