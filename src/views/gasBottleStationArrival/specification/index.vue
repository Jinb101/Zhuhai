<template>
  <div>
    ...
    <!-- <specificationModal @register="registerModal" @success="handleSuccess" /> -->
  </div>
</template>
<script lang="ts">
  ...
  import { columns, searchFormSchema } from './specification.data';

  export default defineComponent({
    name: 'RoleManagement',
    components: { BasicTable, specificationModal, TableAction, AAlert: Alert },
    setup() {
