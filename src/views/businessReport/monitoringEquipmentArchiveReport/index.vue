        ...
        <a-form layout="inline" :model="formState">
          <a-form-item>
            <a-select v-model:value="formState.deviceType" placeholder="气体类型" style="width: 8rem">
              <a-select-option :value="item" v-for="item in deviceTypeList">{{item}}</a-select-option>
            </a-select>
          </a-form-item>
          <a-form-item>
            <a-date-picker
...
export default defineComponent({
  ...
  setup() {
    ...
    function getRandomDateTimeThisYear(): string {
      ...
      const randomTimestamp: number = Math.random() * (endDate.getTime() - startDate.getTime()) + startDate.getTime();
